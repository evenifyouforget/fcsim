...
// of overlapping proxies. It is based closely on code provided by Pierre
// Terdiman. http://www.codercorner.com/IncrementalSAP.txt
...
struct b2PairCallback {
  ...
  // user data is null.
  void *(*PairAdded)(b2PairCallback *callback, void *proxyUserData1,
                     void *proxyUserData2);
  ...
  // existed.
  void (*PairRemoved)(b2PairCallback *callback, void *proxyUserData1,
                      void *proxyUserData2, void *pairUserData);
};
...
void b2PairManager_AddBufferedPair(b2PairManager *manager, int32 proxyId1,
                                   int32 proxyId2);

void b2PairManager_RemoveBufferedPair(b2PairManager *manager, int32 proxyId1,
                                      int32 proxyId2);
