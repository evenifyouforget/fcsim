...
inline b2Vec2 b2Mul(const b2Mat22 &A, const b2Vec2 &v) {
  b2Vec2 u;
  b2Vec2_Set(&u, A.col1.x * v.x + A.col2.x * v.y,
...
inline b2Mat22 b2MulT(const b2Mat22 &A, const b2Mat22 &B) {
  b2Vec2 c1;
  b2Vec2_Set(&c1, b2Dot(A.col1, B.col1), b2Dot(A.col2, B.col1));
  b2Vec2 c2;
  b2Vec2_Set(&c2, b2Dot(A.col1, B.col2), b2Dot(A.col2, B.col2));
  b2Mat22 C;
  b2Mat22_Set(&C, c1, c2);
  return C;
}

inline float64 b2Abs(float64 a) { return a > 0.0 ? a : -a; }

inline b2Vec2 b2Abs(const b2Vec2 &a) {
  b2Vec2 b;
  b2Vec2_Set(&b, fabs(a.x), fabs(a.y));
  return b;
}
