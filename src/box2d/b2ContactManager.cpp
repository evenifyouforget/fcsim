...
static void b2ContactManager_DestroyContact(b2ContactManager *manager,
                                            b2Contact *c);

// This is a callback from the broadphase when two AABB proxies begin
// to overlap. We create a b2Contact to manage the narrow phase.
void *b2ContactManager_PairAdded(b2PairCallback *callback, void *proxyUserData1,
                                 void *proxyUserData2) {
  ...
  if (manager->m_world->m_filter != NULL &&
      manager->m_world->m_filter(shape1, shape2) == false) {
    return &manager->m_nullContact;
  }
  ...
  // Call the factory.
  b2Contact *contact =
      b2Contact_Create(shape1, shape2, &manager->m_world->m_blockAllocator);
...
void b2ContactManager_PairRemoved(b2PairCallback *callback,
                                  void *proxyUserData1, void *proxyUserData2,
                                  void *pairUserData) {
  b2ContactManager *manager = (b2ContactManager *)callback;
