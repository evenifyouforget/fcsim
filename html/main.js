...
// homepage behaviour: quantum leap
if(!design_id && !level_id) {
    ...
    if (notification) {
        ...
        helpDiv.appendChild(chainElement(["p"], "leap variant - design pieces will teleport by +(goal.xy - build.xy) the first time a goal piece enters the goal area"));
